<template>
	<view class="page-scope">
		...
		<HomepageTheme @getliushui="getliushui" :liushuilist="liushuilist" :yfslist="yfslist" :ssjlist="ssjlist" :refreshCounter="refreshCounter"  :getNextPageCounter="getNextPageCounter" v-else-if="renderTheme === 'homepage'" :page="page"></HomepageTheme>
