<template>
	<view class="container" :class="{'dark-bg': isDarkMode}" :style="'height: 100vh; background-image: url(' + bgImage + '); background-size: 100% 100%; background-position: center center;'">
		<TextNavBar :darkMode="isDarkMode" :title="info.title"></TextNavBar>
		
		<image v-if="config.bgm" class="bgm-icon" @tap="$switchBgm" :class="{disable: !isBgmPlay}" mode="widthFix" src="https://api.caihongbox.com.cn/image/music-icon.png"></image>
