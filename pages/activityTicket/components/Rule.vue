		...
		<view class="mask-content animated fadeInDown" @tap.stop>
			...
			<view class="body">
				<ul class="rule-list">
					...
					<li>
						② 被邀请者可获得奖励：<span class="color-text">{{rule.invited_reward || 0}}次</span>。
					</li>
					<li>
						③ 邀请者可获得基础奖励：<span class="color-text">{{rule.per_reward || 0}}次</span>。
					</li>
					<li>
						④ 邀请者可获得额外奖励：
					</li>
					<li>
						...
						<view class="no-added-reward" v-else>
							(无额外奖励)
						</view>
					</li>
					<li>
						⑤ 邀请者累计最高可获得<span class="color-text">{{rule.max_reward || 0}}次</span>奖励。
					</li>
					<li>
						⑥ 每个奖励对应在本活动中一次免费参与机会。即仅限于在活动"{{info.title}}"中使用。
					</li>
					<li>
						⑦ 本活动规则最终解释权归本公司所有。
					</li>
