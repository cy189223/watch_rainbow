<template>
    <view class="container" style="background: url('https://api.caihongbox.com.cn/image/day-task-bg.png'); background-size: 100% auto; background-repeat: no-repeat">
        ...
        <view class="tips-c">
            ...
            <view class="body">
                <p>
                    签到基础奖励为{{ config.base_reward }}{{ scoreAlias }}。 连续签到奖励比前一天的奖励增加{{ config.add_reward }}{{ scoreAlias }}，上限为每天奖励{{
                        config.max_reward
                    }}{{ scoreAlias }}。
                </p>
                <p>如: 第1天签到+{{ config.base_reward }}，第2天签到+{{ config.base_reward + config.add_reward }}, 第3天签到+{{ config.base_reward + config.add_reward * 2 }}</p>
            </view>
        </view>
        ...
        <view class="task-list">
            <view class="item">
                ...
                <button @signIn="signIn" class="btn" v-if="signinProgress != 100">签到</button>
            </view>
            ...
            <view class="item">
                ...
                <button class="btn" open-type="share" v-if="shareProgress != 100">分享</button>
            </view>
        </view>
    </view>
</template>
