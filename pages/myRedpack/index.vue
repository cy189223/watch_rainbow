<template>
    <view class="container" :style="'padding-top:' + (navBar + 150) + 'px'">
        <TextNavBar :title="'我的' + $money()"></TextNavBar>
        ...
        <view class="list">
            <view class="list-item" v-for="item in list" :key="item.uuid">
                <view class="list-body">
                    ...
                    <view class="order-number" v-if="item.order_number">订单号:{{ item.order_number }}</view>
...
<script>
import { getRedpackRecord } from '../../api/user.js';
export default {
    components: {},
    data() {
        return {
...
.top {
    ...
    .card {
        ...
        height: 174rpx;
        background: #ffffff;
        box-shadow: 0px 0 30rpx 0px rgba(170, 85, 255, 0.4);
        border-radius: 20rpx;
        // margin-top: 20rpx;
        margin: 20rpx auto;
        padding: 10rpx 40rpx;
