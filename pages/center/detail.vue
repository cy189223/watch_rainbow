<template>
    <view class="container">
        <view class="header">
            ...
            <button class="right" open-type="contact">
        ...
        <view class="order-c">
            ...
            <view class="body">
                <view class="item" @tap="toDetail('/pages/orderList/index?status=pending')" hover-class="hover">
                    <image mode="widthFix" style="width: 49rpx; height: 59rpx" src="@/static/center/order-pending.png"></image>
                    <text>待处理</text>
                </view>
        ...
        <image class="share-banner" @tap="toDetail('/pages/shareRule/index')" src="https://cdn2.hquesoft.com/box/share-banner.png" hover-class="hover" />
        ...
        <view class="action-list">
            <view class="item" v-for="(item, index) in items" @tap="$tool.toLink(item.link)" hover-class="hover">
                <view class="left-icon">
        ...
        <image
            hover-class="hover"
            :class="{ 'float-icon-animate': isAnimated }"
            src="https://api.caihongbox.com.cn/image/center-float-btn.png"
            class="float-btn"
            @tap="toDayTask"
        ></image>
    </view>
