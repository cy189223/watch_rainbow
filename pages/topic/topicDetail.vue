        ...
        <view class="detail">
            ...
            <view class="body">
                ...
                <view v-if="info.images && info.images.length" class="image-c" :class="'image-c-' + imageList">
                    <image
                        @tap="previewImage(info.images, index)"
                        mode="aspectFill"
                        :src="url + '?x-oss-process=image/resize,w_300'"
                        :key="index"
        ...
        <view class="comment-c">
            ...
            <view class="comment-list">
                ...
                <view class="comment-item" v-for="(item, index) in commentList">
                    ...
                    <view class="body">
                        <view class="parent-comment" v-if="item.parent_comment">@{{ item.parent_comment.user.name }}: {{ item.parent_comment.text }}</view>
