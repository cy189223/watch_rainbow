<template>
    <view class="container">
        ...
        <view class="topic-item-title">
            <cardTitle
                title="热门话题"
                link="/pages/topic/tagList"
                :isShowMore="true"
                leftIcon="https://cdn2.hquesoft.com/box/icon/tag.png"
        ...
        <view class="topic-item-title">
            <cardTitle
                title="最新动态"
                link="/pages/topic/topicList"
                :isShowMore="true"
                leftIcon="https://cdn2.hquesoft.com/box/icon/topic.png"
