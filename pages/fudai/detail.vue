<template>
	<view class="scope-container">
			...
			<view class="topbox">
				...
				<view class="topmainbox">
					...
					<view class="topmainboxb">
						...
						<view class="textbox" @tap="totabbar('/pages/myBox/index')"><text class="new-icon icon-jineqiandaiyueshangjin"></text>我的赏袋</view>
					</view>
				</view>
			</view>
		...
		<view class="footer-c">
			...
			<view class="btn-c">
				<view class="btn" @tap="pay(item.total)" v-for="(item, index) in info.total_list" :key="index" ><view class="chounum">x{{item.total}}</view><view class="choutext">抽{{item.total}}次</view></view>
			</view>
		</view>
