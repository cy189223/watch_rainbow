<template>
	<view class="container">
		...
		<PageRender @getliushuilist="getliushuilist" :page="page" :refreshCounter="refreshCounter" :getNextPageCounter="getNextPageCounter" :yfslist="yfslist" :ssjlist="ssjlist" :liushuilist="list" theme="homepage"></PageRender>
