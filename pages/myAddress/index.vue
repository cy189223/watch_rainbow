...
<script>
import { getAddressList, deleteAddress, createAddress } from '../../api/address.js';
...
export default {
    ...
    onLoad(e) {
        if (e.select) {
            this.select = true;
            this.nowaddress = e.address;
        }
    },
    onUnload() {
        this.list.forEach((item) => {
            if (item.id == this.nowaddress && this.noselect) {
    ...
    methods: {
        ...
        handleEdit(e) {
            ...
            this.$navigator.navigateTo({
                url:
                    `/pages/setAddress/index?uuid=${item.uuid}` +
            ...
            uni.showModal({
                ...
                success: (res) => {
                    if (res.confirm) {
                        ...
                        if (this.list[index].id == this.nowaddress) {
