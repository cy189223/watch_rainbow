    ...
    <view class="container">
        <view class="form">
            <view class="form-item">
                <view class="label-title">收货人</view>
            ...
            <view class="form-item">
                <view class="label-title">所在地区</view>
                <view class="form-item-value">
                    <AreaSelect :value="defaultAddressValue" @change="areaChange"></AreaSelect>
                </view>
            </view>
            <view class="form-item">
                <view class="label-title">详细地址</view>
                <view class="form-item-value">
            ...
            <view class="form-item">
                <view class="label-title" style="width: 200upx">设为默认地址</view>
                <view class="form-item-value">
                    <view class="switch">
                        <switch :checked="form.is_default == 1 ? true : false" color="#6938b6" style="transform: scale(0.8)" @change="switchChange" />
                    </view>
                </view>
            </view>
        </view>
...
export default {
    ...
    computed: {
        ...
        defaultAddressValue() {
            if (!this.form.province) return null;
    ...
    onLoad(e) {
        ...
        if (e.uuid) {
            ...
            this.form = {
                ...
                tag: address.tag == 'null' ? '' : address.tag,
