<template>
    <view class="mask flex-center">
        <view class="content botton-radius">
            ...
            <view class="content-body">
                ...
                <view class="body">
                    <scroll-view class="box-des-scroll" scroll-y="true">
                        <view class="box-des" v-for="(item, index) in desc">{{ index + 1 }}. {{ item }}</view>
                    </scroll-view>
                </view>
            ...
            <image v-if="!is_mandatory" class="close-img" src="./static/app_update_close.png" @click.stop="closeUpdate"></image>
        </view>
    </view>
</template>
